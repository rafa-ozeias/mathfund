...
<form action="adi_8ano.php" method="POST">
...
if(isset($_REQUEST["enviar"])){
    ...
    try{
      ...
      $sql = $conn->prepare("INSERT INTO questoes_8ano (id, enunciado, questao_certa, questao_1, questao_2, questao_3, questao_4, questao_5)
