...
<html lang="pt-br">
  ...
  <body>
    <h1>Adiconar Questão:</h1><br>
<form action="adi_6ano.php" method="POST">

    <!-- enunciado -->
    <div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1">Enunciado</span>
  </div>
...
if(isset($_REQUEST["enviar"])){
    ...
    try{
      ...
      $sql = $conn->prepare("INSERT INTO questoes_6ano (id, enunciado, questao_certa, questao_1, questao_2, questao_3, questao_4, questao_5)
