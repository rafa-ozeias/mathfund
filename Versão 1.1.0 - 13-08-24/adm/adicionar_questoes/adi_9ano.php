...
<form action="adi_9ano.php" method="POST">
...
if(isset($_REQUEST["enviar"])){
    ...
    try{
      ...
      $sql = $conn->prepare("INSERT INTO questoes_9ano (id, enunciado, questao_certa, questao_1, questao_2, questao_3, questao_4, questao_5)
