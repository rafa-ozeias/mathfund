...
<head>
    ...
    try{
        ...
        if(isset($_REQUEST['al'])){
            ...
            $conn = $conn->prepare("SELECT * FROM questoes_7ano WHERE id = :id");
...
<body>
    ...
    <form name="form" action="alt7ano.php" method="POST">
    ...
    if(isset($_REQUEST["alterar"])){
        ...
        try{
            ...
            $sql = $conn->prepare("UPDATE questoes_7ano SET enunciado = :enunciado, questao_certa = :questao_certa, questao_1 = :questao_1, questao_2 = :questao_2, questao_3 = :questao_3, questao_4 = :questao_4, questao_5 = :questao_5 WHERE id = :id");
    ...
    if(isset($_REQUEST["excluir"])){
        ...
        try{
            $sql = $conn->prepare("DELETE FROM questoes_7ano WHERE id = :id");
			$sql->bindValue(":id",$id);
			$sql->execute();
