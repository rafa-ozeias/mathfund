...
if(isset($_REQUEST["al"])){
    $soma = $_REQUEST["al"];
    $_SESSION["id_fases_7ano"] = $_SESSION["id_fases_7ano"] + $soma;
...
?>
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ExemploModalCentralizado">
    ...
    <div class="resposta">
        ...
        <a href="../unidade2-1.php"><img src="../../../../IMG/icons/voltar.png" alt="botão de voltar"></a>
