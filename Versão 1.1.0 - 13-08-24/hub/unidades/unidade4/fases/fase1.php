...
if(isset($_REQUEST["al"])){
    $soma = $_REQUEST["al"];
    $_SESSION["id_fases_9ano"] = $_SESSION["id_fases_9ano"] + $soma;
...
if($vida == 0){
      echo "<script>
    setTimeout(function() {
        window.location.href = '../unidade4-1.php';
    }, 1000);
    </script>";
}
...
?>
    ...
    <div class="resposta">
        ...
        <a href="../unidade4-1.php"><img src="../../../../IMG/icons/voltar.png" alt="botão de voltar"></a>
